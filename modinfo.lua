...
meta =
{
    ...
    title = "claim.lua claim() hook",

    -- Description of your mod that will be displayed to players
    description = "This mod is a small extension to /entity/claim.lua: claim(). It allows other scripts to hook in before the script terminates itself.",
